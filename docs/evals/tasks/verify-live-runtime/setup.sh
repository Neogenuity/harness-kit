...
cp "$root/plugins/harness-kit/skills/harness-kit/templates/scripts/dev-instance.sh" scripts/dev-instance.sh
chmod +x scripts/dev.sh scripts/dev-instance.sh
